...
La figura 1 muestra el Perfil Axial de Temperatura a los $t = 100$ minutos. Esta figura es esencial para validar el modelo 1-D y visualizar el fenómeno de la Termoclina. La pendiente de la curva en el eje $z$ (posición axial) representa el frente de calor; un frente que ha avanzado menos (curva más a la derecha y más cercana a $80^\circ\mathrm{C}$) indica que el material ha absorbido más calor en el mismo tiempo.La Magnetita y la Alúmina tienen los perfiles más a la derecha, confirmando su mayor capacidad volumétrica. La Escoria de Cobre (ESN) muestra un rendimiento casi idéntico al Basalto en esta figura, pero es superior al Hormigón y a los Residuos, confirmando su viabilidad para la sustitución de materiales importados.

La Curva de Salida es la métrica directa de eficiencia de almacenamiento. Muestra la temperatura del fluido a la salida del estanque a lo largo del tiempo de carga. Una curva que se mantiene baja (cercana a la temperatura inicial de $20^\circ\mathrm{C}$) indica una mayor capacidad térmica volumétrica ($\rho \cdot C_p$), lo que significa que el material absorbe más energía por volumen y prolonga el tiempo de descarga.El análisis de la Figura 2 revela un claro liderazgo de los materiales de alta densidad: la Magnetita (curva más baja) demuestra el mejor rendimiento del benchmark, ya que logra la mayor capacidad volumétrica. Es crucial notar que la Escoria de Cobre (ESN) y el Gabro se posicionan inmediatamente debajo del grupo líder, superando claramente a las rocas de menor densidad como la Caliza y los Residuos de Demolición. Esto valida a la Escoria de Cobre como una alternativa de alto rendimiento y alto impacto nacional.


En conclusión la Escoria de Cobre y la Magnetita poseen el mejor rendimiento de almacenamiento volumétrico, superando a las rocas geológicas más comunes (Basalto, Granito), validando una alternativa de alto impacto para la industria nacional Chilena.
